...
import { load } from "lib/inference";
...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="layout border-b border-gray-200">
      <div className="flex items-center justify-between w-full py-4 px-6">
        <Link href="/" className="flex items-center gap-2 text-lg text-green-600 font-bold">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden flex flex-col space-y-2 mt-4 pb-4">
          <Link href="/fitbit">
